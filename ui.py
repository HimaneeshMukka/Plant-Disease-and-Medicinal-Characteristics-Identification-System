...
##            button3.grid(column=0, row=6, padx=10, pady=10)
            ...
            button = tk.Button(text="Exit", command=exit)
            button.grid(column=0, row=9, padx=20, pady=20)
        elif str_label == 'unknown':
            r = tk.Label(text='Plant is Unknown', background="lightgreen", fg="Black",
                         font=("", 15))
            r.grid(column=0, row=4, padx=10, pady=10)
            button = tk.Button(text="Exit", command=exit)
            button.grid(column=0, row=9, padx=20, pady=20)
...
def openphoto():
    ...
    fileName = askopenfilename(initialdir='C:/Users/acer/Desktop/PlantDisease-master/test/test', title='Select image for analysis ',
                           filetypes=[('image files', '.jpg')])
    dst = "C:/Users/acer/Desktop/PlantDisease-master/testpicture"
    print(fileName)
